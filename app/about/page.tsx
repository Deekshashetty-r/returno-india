    ...
    <>
      <section className="relative pt-36 pb-20 border-b border-gray-200 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative">
          ...
          <h1 className="font-display text-5xl lg:text-7xl font-bold text-gray-900 leading-tight mb-6 max-w-3xl">
      ...
      <section className="section-pad">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <span className="accent-line" />
              <h2 className="animate-on-scroll font-display text-4xl lg:text-5xl font-bold text-gray-900 mb-8">
                Our Story
              </h2>
            ...
            <div className="space-y-4">
              <div className="animate-on-scroll service-card p-8">
                ...
                <p className="text-gray-900 font-display text-xl font-medium leading-snug">
          ...
          <div className="services-grid">
            {values.map(({ title, desc }, i) => (
              <div key={title} className={`animate-on-scroll delay-${(i + 1) * 100} service-card`}>
                <h3 className="font-display text-2xl font-bold text-gray-900 mb-4">{title}</h3>
      ...
      <section className="section-pad border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <span className="accent-line" />
          <h2 className="animate-on-scroll font-display text-4xl lg:text-5xl font-bold text-gray-900 mb-14">
            What We Focus On
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={area} className={`animate-on-scroll delay-${(i % 2 + 1) * 100} flex gap-6 p-6 service-card`}>
                ...
                <div>
                  <h3 className="text-gray-900 font-medium mb-2">{area}</h3>
